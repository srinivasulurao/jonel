...
if ($canEdit) {
	$titleBlock->addCell(('<input type="submit"  style="bottom:6px;position:relative" class="button" value="' . $AppUI->_('new company') 
	                      . '">'), '', '<form action="?m=companies&amp;a=addedit" method="post">', 
	                     '</form>');
}

$titleBlock->addCell('<a style=\'text-decoration:none;bottom: 6px;position:relative;padding: 1px;\' href="?m=companies&a=monthly_maintenance_report" class="button">Monthly Maintenance Report</a>');
$titleBlock->show();
