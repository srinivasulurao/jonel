        ...
        <table>
            <tr>
                ...
                <?php $checkedarrray = htmlspecialchars($obj->company_application);
                            $editcheckedarrray = htmlspecialchars($obj->company_application);
                        $checkedarrray = explode(',',$checkedarrray);                
                ?>
                <td align="left" vertical-align="top" style="vertical-align:top !important">
                    <?php echo $AppUI->_('Application Type'); ?>:
                        <?php if($company_id!=0){ ?>
                            <input type="hidden" class="text" id="resultarray" name="company_application" value="<?php echo $editcheckedarrray; ?>"/>
                        <?php }else{ ?>
                ...
                <td>
                    ...
                    <div class="date" style="clear:both;display:none;">
                       ...
                       <span style='vertical-align:top'>Software Module Details :</span>
                        <textarea name='software_module_details' id='software_module_details' style='width:400px;height:100px'><?php echo dPformSafe(@$obj->software_module_details); ?></textarea>
                    </div>
                    <?php //echo arraySelect($array, 'application_period', 'size="1" class="text"', @$obj->application_period, true);?>
