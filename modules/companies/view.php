                ...
                <table>
                    ...
                    <?php if (in_array("Access unlimited",$resultarray)){?>
                        ...
                        <tr>
                            ...
                            ?>
                            <td align="right" nowrap="nowrap"><?php echo $AppUI->_('AU Maintenance Period'); ?>:</td>
                            <td class="hilite"><?php echo $found; ?></td>
                        </tr>
                        <tr><td>Software Module Details:</td><td class="hilite" style='vertical-align:top'><?php echo htmlspecialchars($obj->software_module_details); ?></td></tr>
                    <?php } ?>
                </table>
                <?php } ?>
		<?php
