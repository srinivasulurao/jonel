...
<script type="text/javascript">
    ...
    $s(function(){
	    ...
	    var url='http://support.jonel.com:8100/dptest/modules/helpdesk/comp.php';
            //alert(url);
    ...
    $s(document).ready(function(){
            ...
            var domain1=document.domain;
	    var url='http://support.jonel.com:8100/dptest/modules/helpdesk/comp1.php';
            //alert(url);
            //var url='http://localhost:8080/dotproject/modules/helpdesk/comp.php';
            $s.ajax({
                type: "POST",
