...
$sql = "SELECT hi.*,
	...
	AND hi.item_status != 2 
	AND hi.item_status != 4
...
<tr>
	...
	<th nowrap="nowrap"><?=$AppUI->_('Number')?></th>
	<th nowrap="nowrap"><?=$AppUI->_('Requestor')?></th>
        <th nowrap="nowrap"><?=$AppUI->_('Company')?></th>
	<th nowrap="nowrap"><?=$AppUI->_('Title')?></th>
	<!--<th nowrap="nowrap"><?=sort_header("item_assigned_to", $AppUI->_('Assigned To'))?></th>-->
	<th nowrap="nowrap"><?=$AppUI->_('Status')?></th>
	<th nowrap="nowrap"><?=$AppUI->_('Priority')?></th>
	<th nowrap="nowrap"><?=$AppUI->_('Project')?></th>
</tr>
<?php
$s = '';
