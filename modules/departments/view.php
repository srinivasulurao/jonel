...
<tr valign="top">
	<td width="50%">
		...
		<tr>
			...
			<td bgcolor="#ffffff" width="100%"><?php echo (($batching_expire_date) ? $batching_expire_date->format($df) : '');?></td>
		</tr>
		</table>
	</td>
	<td width="50%">
			...
			<td bgcolor="#ffffff" width="100%"><?php echo str_replace(chr(10), "<br />", $dept['dept_desc']);?>&nbsp;</td>
                ...
                <table>
                    <tr>
                        ...
                        ?>
                        <td align="right"><?php echo $AppUI->_('Batch Type'); ?>:</td>
                        <td bgcolor="#ffffff" width="80%"><?php echo $found;?></td>
                    </tr>
                </table>
	</td>
</tr>
